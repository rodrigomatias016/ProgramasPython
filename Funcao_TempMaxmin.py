####Criar um programa que analisa uma lista de temperaturas(array) e descobre máxima e mínima####
...
def testa_mínima():
    ...
    teste_pontual([30, 27, 25, 26, 29, 31, 32, 33, 30, 29, 24, 22, 26, 30, 27, 24, 25, 26, 24], 22)
    teste_pontual([-15, -12, 0, 20, 30], -15)    
    print("Finalizando os teses")    
